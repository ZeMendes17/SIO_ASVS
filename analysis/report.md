...
A careful analysis of the application was performed in order to identify vulnerabilities. Out of the 280 AVSV requirements our system complied with 72 at first. After the analysis, we were able to mitigate 24 vulnerabilities, resulting in a total of 96 AVSV requirements complied. Almost all of the level 1 requirements were met, and some level 2 requirements were also met.
